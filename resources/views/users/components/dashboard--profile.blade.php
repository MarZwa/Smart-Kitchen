...
<section class="dashboard__profile u-z-2">
    ...
    <section class="dashboard__profile__body">
        <ul class="dashboard__profile__menu">
            ...
            <li class="dashboard__profile__menu__item"><a class="dashboard__profile__menu__item__link" href="/users/{id}/grocerylist">Grocery List</a></li>
            <li class="dashboard__profile__menu__item"><a class="dashboard__profile__menu__item__link" href="/users/{id}/storagelist">Storage List</a></li>
